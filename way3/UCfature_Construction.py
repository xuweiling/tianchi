...
userSub = userAll[(userAll['time_day'] >=day_3) & (userAll['time_day'] <=day_1)]
userSub = userSub[['user_id', 'item_category', 'type_1', 'type_2', 'type_3', 'type_4']]
userSub = userSub.groupby(['user_id', 'item_category'], as_index=False).sum()
...
userSub = userAll[(userAll['time_day'] >=day_6) & (userAll['time_day'] <=day_1)]
userSub = userSub[['user_id', 'item_category', 'type_1', 'type_2', 'type_3', 'type_4']]
userSub = userSub.groupby(['user_id', 'item_category'], as_index=False).sum()
...
userSub1.insert(5, 'uc_b1_last_hours', (to_time(pred_day) - userSub1['time_day'].map(lambda x:to_time(x))).map(lambda x:((x.days)*24)).map(lambda x:int(x))
...
userSub2.insert(5, 'uc_b2_last_hours', (to_time(pred_day) - userSub2['time_day'].map(lambda x:to_time(x))).map(lambda x:((x.days)*24)).map(lambda x:int(x))
...
userSub3.insert(5, 'uc_b3_last_hours', (to_time(pred_day) - userSub3['time_day'].map(lambda x:to_time(x))).map(lambda x:((x.days)*24)).map(lambda x:int(x))
...
userSub4.insert(5, 'uc_b4_last_hours', (to_time(pred_day) - userSub4['time_day'].map(lambda x:to_time(x))).map(lambda x:((x.days)*24)).map(lambda x:int(x))
